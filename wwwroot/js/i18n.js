...
const translations = {
    en: {
        ...
        'animations.scrubStripHint': 'Drag to scrub · Drag markers to retime (Shift = no snap) · Double-click to add · Space play/pause · Del removes selected · ←/→ nudge',
    ...
    zh: {
        ...
        'animations.scrubStripHint': '拖动预览 · 拖动关键帧调整时间（Shift 关闭吸附）· 双击添加 · 空格播放/停止 · Del 删除选中 · ←/→ 微调',
