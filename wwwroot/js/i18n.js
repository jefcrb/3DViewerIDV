...
const translations = {
    en: {
        ...
        'world.skyboxImage': 'Skybox image',
        ...
        'world.addFilter': '+ Add filter',
        'world.filterMoveUp': 'Move up',
        'world.filterMoveDown': 'Move down',
        'world.filterRemove': 'Remove filter',
        'world.filterType.pixelate': 'Pixelate',
        'world.filterType.scanlines': 'Scanlines',
        'world.filterType.chromaticAberration': 'Chromatic aberration',
        'world.filterParam.pixelSize': 'Pixel size',
        ...
        'animations.scrubTitle': 'Scrub timeline (preview at time)',
        'animations.scrubClose': 'Close scrubber',
        'animations.scrubStripHint': 'Drag to scrub · Double-click to record all properties · Click channel dots to select · Ctrl+C / Ctrl+V / Delete on a channel keyframe',
        'animations.scrubHint': 'Click a keyframe to select and edit.',
        'animations.scrubDelete': 'Delete',
        'animations.scrubDeleteTitle': 'Delete this keyframe (Del)',
        'animations.scrubAddTitle': 'Add keyframe at playhead (captures current scene)',
        'animations.scrubSelectedKf': 'Selected',
        'animations.scrubNextKf': 'Next kf',
        'animations.scrubPrevKf': 'Prev kf',
        'animations.scrubGoNextTitle': 'Jump to next keyframe',
        'animations.scrubGoPrevTitle': 'Jump to previous keyframe',
        'animations.scrubChangeVsPrev': 'Changes vs previous keyframe:',
        'animations.scrubNoChange': 'No animated changes from previous keyframe.',
        'animations.scrubNoPrev': 'No previous keyframe.',
        'animations.scrubKfName': 'Keyframe',
        'animations.scrubJumpTitle': 'Click to jump-select this keyframe',
        'animations.scrubDragHint': 'Hold Shift for fine control · Shift also allows dragging past neighboring keyframes',
        'animations.deletePropTitle': 'Delete this property from this keyframe',
        'animations.ctxAddHere': 'Add keyframe here',
        'animations.ctxPasteHere': 'Paste keyframe here',
        'animations.ctxCopy': 'Copy keyframe',
        'animations.ctxDelete': 'Delete keyframe',
        'animations.scrubEmptyHint': 'Click a channel keyframe to edit its value, retime it, or copy/paste it.',
        'animations.ctxLock': 'Lock keyframe',
        'animations.ctxUnlock': 'Unlock keyframe',
        'animations.lockedTitle': 'Locked — unlock via right-click to edit',
        'animations.easingPickerTitle': 'Click to change easing',
        'animations.scrubSnapshotTitle': 'Snapshot: record a keyframe at the playhead with the current editor camera pose',
    ...
    zh: {
        ...
        'world.filters': '滤镜',
        'world.addFilter': '+ 添加滤镜',
        'world.filterMoveUp': '上移',
        'world.filterMoveDown': '下移',
        'world.filterRemove': '移除滤镜',
        'world.filterType.pixelate': '像素化',
        'world.filterType.scanlines': '扫描线',
        'world.filterType.chromaticAberration': '色差',
        'world.filterParam.pixelSize': '像素大小',
        ...
        'animations.scrubTitle': '拖动时间线（预览指定时刻）',
        'animations.scrubClose': '关闭拖动条',
        'animations.scrubStripHint': '拖动预览 · 双击记录所有属性 · 点击通道圆点选中 · 在通道关键帧上使用 Ctrl+C / Ctrl+V / Delete',
        'animations.scrubHint': '点击一个关键帧以选择并编辑。',
        'animations.scrubDelete': '删除',
        'animations.scrubDeleteTitle': '删除此关键帧 (Del)',
        'animations.scrubAddTitle': '在播放头位置添加关键帧（捕获当前场景）',
        'animations.scrubSelectedKf': '当前',
        'animations.scrubNextKf': '下一帧',
        'animations.scrubPrevKf': '上一帧',
        'animations.scrubGoNextTitle': '跳转到下一关键帧',
        'animations.scrubGoPrevTitle': '跳转到上一关键帧',
        'animations.scrubChangeVsPrev': '相对上一关键帧的变化：',
        'animations.scrubNoChange': '与上一关键帧无动画差异。',
        'animations.scrubNoPrev': '没有上一关键帧。',
        'animations.scrubKfName': '关键帧',
        'animations.scrubJumpTitle': '点击跳转到此关键帧',
        'animations.scrubDragHint': '按住 Shift 进行精细控制 · 按住 Shift 也可拖动越过相邻关键帧',
        'animations.deletePropTitle': '删除此关键帧的该属性',
        'animations.ctxAddHere': '在此添加关键帧',
        'animations.ctxPasteHere': '在此粘贴关键帧',
        'animations.ctxCopy': '复制关键帧',
        'animations.ctxDelete': '删除关键帧',
        'animations.scrubEmptyHint': '点击通道关键帧以编辑其值、调整时间或复制/粘贴。',
        'animations.ctxLock': '锁定关键帧',
        'animations.ctxUnlock': '解锁关键帧',
        'animations.lockedTitle': '已锁定 — 右键解锁后可编辑',
        'animations.easingPickerTitle': '点击更改缓动曲线',
        'animations.scrubSnapshotTitle': '快照：以当前编辑器摄像机姿态在播放头处录制关键帧',
